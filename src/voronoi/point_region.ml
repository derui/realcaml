...
module Region = struct
  ...
  let recent_point ~point t =
    let open V.Open in
    let { base = p; a_normal = e1; b_normal = e2; _ } = t in
    let base = point -: p in
...
let point_of_contained_edge v (e1, e2, e3) =
  ...
  let cont_e1 = point_contained e1 v and cont_e2 = point_contained e2 v and cont_e3 = point_contained e3 v in
...
let make (e1, e2, e3) normal point =
  ...
  let a = V.sub e12 e11 |> V.normalize and b = V.sub e21 e22 |> V.normalize in
