(** Providing some operations to manage relations between edges and relations. The relations is based on id of the edge
    contained a facet, user can find facets contains the edge.
